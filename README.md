...
## Project Structure
    ...
    ├── appwithoutemail_dev_23643  # Django project configurations
...
1. Clone this repo and `cd appwithoutemail_dev_23643`
...
2. Clone this repo and `cd appwithoutemail_dev_23643`
